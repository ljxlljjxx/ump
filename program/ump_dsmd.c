...
{	
	...
	for (int i = 1; i < argc; i++)
	{
		...
		{
			file_temp = fopen("/Users/ljx/useful_mini_program/temp/dsmd", "w");
			...
			file = fopen(argv[i], "w");
			file_temp=fopen("/Users/ljx/useful_mini_program/temp/dsmd", "r");
